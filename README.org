...
| wallabag-request-new-entries             | Retrieve the new entries in the background.                                                            |
| wallabag-request-and-synchronize-entries | Retrieve and synchronize entries, controlled by ~wallabag-number-of-entries-to-be-synchronized~.         |
